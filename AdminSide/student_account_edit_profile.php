				...
				<div data-perfect-scrollbar>
					<div class="page-section pt-lg-32pt">
						<ul class="nav page-nav__menu">
							<li class="nav-item">
								<a href="student-account-edit-basic.html" class="nav-link">Basic Information</a>
							</li>
							<li class="nav-item">
								<a href="student-account-edit-profile.html" class="nav-link active">Profile &amp; Privacy</a>
							</li>
						</ul>
