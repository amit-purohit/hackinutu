...
<body class=" layout-fluid">
    ...
    <!-- Header Layout -->
    <div class=" js-mdk-header-layout">
        <!-- Header -->
                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0">
                    <div class="container-fluid">
                        ...
                        <a href="student-dashboard.html" class="navbar-brand">
                            ...
                            <span class="d-none d-xs-md-block">BCA Stuffs</span>
                        </a>
                        <!-- Search -->
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item dropdown dropdown-notifications dropdown-menu-sm-full">
                                ...
                                <!-- <div class="dropdown-header"><strong>System notifications</strong>
      <div class="list-group list-group-flush mb-0">
            ...
            <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                <div class="sidebar-p-y">
                    ...
                    <ul class="sidebar-menu sm-active-button-bg">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="instructor_dashboard.php">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu sm-indent collapse" id="account_menu">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="forgotpassword.php">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                        href="student-account-billing-payment-information.php">
                    ...
                    <!-- add or upload course -->
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button sidebar-js-collapse" data-toggle="collapse"
                                href="#add_course_menu">
                                <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">person_outline</i>
                                Add Or Upload Course
                                <span class="ml-auto sidebar-menu-toggle-icon"></span>
                            </a>
                            <ul class="sidebar-submenu sm-indent collapse" id="add_course_menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="add_course.html">
                                        <span class="sidebar-menu-text">Add course</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="upload.html">
                                        <span class="sidebar-menu-text">Upload Course</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <!-- add or upload ends here -->
                        <li class="sidebar-menu-item">
