    ...
    <div class="card">
        ...
        <div class="tab-content card-body">
                            ...
                            <tbody class="">
                                ...
                                while($result3=mysqli_fetch_array($run2))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" id="delete" name="delete" value="<?php echo $result3['user_id']; ?>">


                                            <a href="userdel.php?id=<?php echo $result3[0]; ?>" onclick="return confirm('Do You want to delete?') " >
            ...
            if(isset($_POST['save']))
            {
                ...
                $sql3="UPDATE user_master SET user_name='$username',email='$useremail',password='$password' WHERE user_id=$userid";
                //echo $sql3;
