								...
								<div class="row card-group-row mb-40pt">
									...
									<div class="col-lg-6 col-sm-6 card-group-row__col">
										...
										<div class="card card-group-row__card text-center o-hidden">
											...
											<div class="card-footer">
												<a href="student-account-billing-payment-information.html" class="btn btn-success">Get started</a>
											</div>
										</div>
								...
								<div data-perfect-scrollbar>
									<div class="page-section pt-lg-32pt">
										<ul class="nav page-nav__menu">
											...
											<li class="nav-item">
												<a href="student-account-billing-upgrade.html" class="nav-link active">Upgrade Account</a>
											</li>
											<li class="nav-item">
