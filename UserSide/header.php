...
<head>
  ...
  <!--<script src="./../bootstrap/jquery/jquery-ui.min.css"></script> -->
          <!-- <script src="./../bootstrap/jquery/jquery-3.1.1.min.js"></script>
          <script src="./../bootstrap/jquery/jquery-ui.min.js"></script>
          <link rel="stylsheet"  href="./../bootstrap/css/bootstrap.min.css"> -->
        <!-- <link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css">
        <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
        <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->

        <!-- slider js & css files -->
        <link rel="stylesheet" href="./../bootstrap/sliderjs/jquery-ui.css">
        <script src="./../bootstrap/sliderjs/jquery-1.12.4.js"></script>
        <script src="./../bootstrap/sliderjs/jquery-ui.js"></script>
      ...
      <div class="container">
        <div class="navbar p-0 navbar-expand-lg">
          <div class="navbar-brand">
            <a class="logo-default" href="index.php"><img alt="" src="assets/img/bca.png"></a>
          </div>
...
<!--               <ul class="dropdown-menu">
            ...
            <li class="nav-item nav-item__has-dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <li class="nav-item__has-dropdown">
                  <a class="nav-link__list " href="contact.php" > Support </a>
                  <!-- <div class="dropdown-menu">
                    <ul class="list-unstyled">
                      ...
                      <li><a class="nav-link__list" href="page-help-&-support-details.php"> Support Details</a></li>
                      <li><a class="nav-link__list" href="page-terms-and-privacy-policy.php"> Privacy Policy </a></li>
                    </ul>
                  </div> -->
                </li>
                ...
                <li class="nav-item__has-dropdown">
                  ...
                  <div class="dropdown-menu">
                    <ul class="list-unstyled">
                      ...
                      <li><a class="nav-link__list" href="page-recover-password.php"> Reset Password</a></li>
                      <li><a class="nav-link__list" href="page-sp-student-profile.php"> Students Profile</a></li>
                      <li><a class="nav-link__list" href="page-user-profile.php">  Instructors Profile</a></li>
                      <li><a class="nav-link__list" href="page-sp-become-instructor.php">  Become Instructors</a></li>
                      <li><a class="nav-link__list" href="page-sp-order-details.php">  Order Details</a></li>
                    </ul>
                  </div>
                </li>

                <li class="nav-item__has-dropdown">
                  <a class="nav-link__list " href="givequiz.php" >Quiz </a>
                </li>
                ...
                <li class="nav-item__has-dropdown">
                  ...
                  <div class="dropdown-menu">
                    <ul class="list-unstyled">
                      <li><a class="nav-link__list" href="page-notice.php"> Notices </a></li>
                      <li><a class="nav-link__list" href="page-notice-details.php"> Notics Details</a></li>
                    </ul>
                  </div>
                </li>
                ...
                <li class="nav-item__has-dropdown">
                  ...
                  <div class="dropdown-menu">
                    <ul class="list-unstyled">
                      <li><a class="nav-link__list" href="page-sp-faculty.php"> Faculty </a></li>
                      <li><a class="nav-link__list" href="page-sp-research.php"> Research </a></li>
                      <li><a class="nav-link__list" href="page-sp-research-details.php"> Research Details</a></li>
                      <li><a class="nav-link__list" href="page-sp-scholarship.php"> Scholarship</a></li>
                    </ul>
                  </div>
                </li>
                ...
                <!-- <li class="nav-item__has-dropdown">
                  ...
                  <div class="dropdown-menu">
                    <ul class="list-unstyled">
                      <li><a class="nav-link__list" href="page-career.php"> Careers </a></li>
                      <li><a class="nav-link__list" href="page-career-details.php"> Career Details </a></li>
                    </ul>
                  </div>
                </li> -->

               <!--  <li>
                 <a class="nav-link__list" href="page-sp-vc.php">VC</a>
               </li> -->
               <li>
                <a class="nav-link__list" href="page-faq.php"> FAQs </a>
              </li>
              <li>
               <a class="nav-link__list" href="page-contact.php">Feedback</a>
             </li>
       ...
       <li class="nav-item nav-item__has-dropdown">
        ...
        <div class="dropdown-menu">
          <ul class="list-unstyled">
           ...
           <li class="nav-item__has-dropdown">
            ...
            <li><a class="nav-link__list" href="blog-standard.php"> By Student </a></li>
            <li><a class="nav-link__list" href="blog-card.php"> By Instructor </a></li>
        ...
        <!-- <li class="nav-item__has-dropdown">
          ...
          <div class="dropdown-menu">
            <ul class="list-unstyled">
              <li><a class="nav-link__list" href="blog-single.php"> Image </a></li>
              <li><a class="nav-link__list" href="blog-single-audio.php"> Audio </a></li>
              <li><a class="nav-link__list" href="blog-single-soundcloud.php"> Sound Cloud </a></li>
              <li><a class="nav-link__list" href="blog-single-video-HTML5.php"> HTML5 Video </a></li>
              <li><a class="nav-link__list" href="blog-single-video-youtube.php"> Youtube Video </a></li>
              <li><a class="nav-link__list" href="blog-single-video-vimeo.php"> Vimeo Video </a></li>
            </ul>
          </div>
        </li> -->
      </ul>
  ...
  <li class="nav-item nav-item__has-dropdown">
    ...
    <div class="dropdown-menu">
      <ul class="list-unstyled">
        <li>
          <a class="nav-link__list" href="book.php"> Shop Books </a>
        </li>
        <li>
          <a class="nav-link__list" href="shop-cart.php"> Cart</a>
        </li>
        <!-- <li>
          <a class="nav-link__list" href="shop-checkout.php"> Checkout</a>
        </li> -->
        <!-- <li>
          <a class="nav-link__list" href="shop-order-success.php">Order Success</a>
        </li> -->
