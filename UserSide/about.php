  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-5 mb-4 mr-auto text-center">
        <img class="wow fadeInLeft w-100 rounded" src="./assets/img/avatar/1_1.png" alt="">
      </div> 
      ...
      <div class="col-lg-6">
        ...
        <p class="mb-5">
          We are here to guide you the best and try to be best in ourself to help you out and bring out the excellence out of you.
        </p>
        <ul class="list-unstyled list-style-icon list-icon-check-circle">
          ...
          <li>
           Best courses offered at lowest price
          </li>
          <li>
            Best professor to teach you
          </li>
        </ul>
      ...
      <div class="col-lg-6 mt-2 wow fadeInUp">
        <div class="row">
          <div class="col-md-6 my-2">
            <img src="./facultyImages/<?php echo $row[pic]; ?>" alt="" style="height:255px; width:255px;">
          </div>
          <div class="col-md-6 my-4">
            ...
            <p class="text-muted mb-0">
              <strong>Specialized in:</strong><?php echo $row[specialized_in]; ?>
            </p>
            <p class="my-4">
              <strong>Courses Uploaded:</strong><br>
              <?php
                echo $row[course];
              ?>
            </p>
