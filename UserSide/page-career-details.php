       ...
       <div class="col-lg-3 col-md-4">
         <div class="card padding-30 shadow-v1  marginTop-30">
           ...
           <ul class="list-unstyled">
             ...
             <li class="mb-3">
               <i class="fas fa-briefcase mr-1"></i> <span class="font-weight-semiBold">Job Type:</span> <br>
               Full time
             </li>
             <li class="mb-3">
               <i class="fas fa-dollar-sign mr-1"></i> <span class="font-weight-semiBold">Salary: </span> <br> 
               $47,000 - $102,000
             </li>
             <li class="mb-3">
         ...
         <div class="card padding-30 shadow-v1  marginTop-30">
           <h4 class="mb-3">Company Info</h4>
            <ul class="list-unstyled">
              <li>
                <span class="font-weight-semiBold">Address:</span> London, UK
              </li>
              <li>
                <span class="font-weight-semiBold">Compnay SIze:</span>  2k Employee
              </li>
              <li>
                <span class="font-weight-semiBold">Industry:</span> <a href="#">Technology</a>
              </li>
              <li>
                <span class="font-weight-semiBold">Phone:</span> +1234 567 8910
              </li>
              <li>
                <span class="font-weight-semiBold">Email:</span> <a href="#">info@dropbox.com</a>
              </li>
              <li>
                <span class="font-weight-semiBold">Website:</span> <a href="#">www.dropbox.com</a>
              </li>
            </ul>
     ...
     <div class="row">
       ...
       <div class="col-lg-9 mx-auto mt-5">
         <form class="row" action="#" method="POST">
           ...
           <div class="col-md-6 mb-4">
             <input type="text" class="form-control rounded-pill" placeholder="Phone">
           </div>
           <div class="col-md-6 mb-4">
             <input type="text" class="form-control rounded-pill" placeholder="Website">
           </div>
           <div class="col-md-6 mb-4">
             <input type="text" class="form-control rounded-pill" placeholder="Location">
           </div>
           <div class="col-12 mb-4">
             <textarea type="text" class="form-control rounded-pill" rows="5" placeholder="More Info"></textarea>
           </div>
