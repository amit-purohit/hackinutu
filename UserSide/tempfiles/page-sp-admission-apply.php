...
<div class="padding-y-60 bg-cover" data-dark-overlay="6" style="background:url(assets/img/breadcrumb-bg.jpg) no-repeat">
  <div class="container">
    <ol class="breadcrumb breadcrumb-double-angle text-white bg-transparent p-0">  
      ...
      <li class="breadcrumb-item">Admission Apply</li>
    </ol>
  ...
  <section class="paddingTop-70 paddingBottom-100">
  <div class="container">
    <div class="row">
     <div class="col-12 text-center">
      ...
      <div class="col-md-6 mt-5">
       <img src="assets/img/600x432/3.jpg" alt="">
  ...
  <div class="container">
    <div class="row">
     <div class="col-12 text-center mb-5">
      ...
      <div class="col-12 text-center">
        <form action="#" method="POST" class="card p-md-5 shadow-v2">
          <p>
            Investig tiones demons travge wunt ectores legere lkurus quod legunt saepiu clartas est consectetur <br>adipi sicing elitsed kdo eusmod tempor cididunt.
          </p>
          <div class="row mt-4 mx-0">
            ...
            <div class="col-12">
              <textarea type="email" class="form-control" placeholder="Phone number" rows="7"></textarea>
