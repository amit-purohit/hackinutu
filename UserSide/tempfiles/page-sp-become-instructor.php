        ...
        <div class="card text-center shadow-v3 p-5">
          ...
          <form action="#" method="POST" class="mt-4">
            <div class="input-group input-group--focus mb-3">
              ...
              <input type="text" class="form-control border-left-0 pl-0" placeholder="Name" required>
            </div>
            <div class="input-group input-group--focus mb-3">
              <div class="input-group-prepend">
            ...
            <p class="marginTop-40">
              Already have an account? <a href="page-login.html" class="text-primary">Log In</a>
            </p>
          </form>
        </div>
      </div>
