        ...
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Bootstrap:The Reference Guide</h6>
                <small class="text-muted">Compelete reference about boostrap</small>
              </div>
              <span class="text-muted">₹100</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Jquery Handbook</h6>
                <small class="text-muted">Faster way to learn jquery</small>
              </div>
